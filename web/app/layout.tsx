...
export const metadata: Metadata = {
  ...
  description:
    "Calibrated posteriors over LLM-judge scores. Aleatoric/epistemic decomposition, conformal prediction with finite-sample guarantees, Thompson-sampling jury routing.",
};
